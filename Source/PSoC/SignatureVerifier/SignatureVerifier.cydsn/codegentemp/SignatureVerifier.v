...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("0148deeb-dd41-4c2c-8566-918d48f448e4"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("7fe2412e-8b42-4813-9dd8-475071d852f5"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Pin_Button_Interrupt_net;
	wire [0:0] tmpIO_0__Pin_Button_Interrupt_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Button_Interrupt_net;
	electrical [0:0] tmpSIOVREF__Pin_Button_Interrupt_net;

	cy_psoc3_pins_v1_10
		#(.id("86f6e3f7-f6e3-43e5-95c4-feb99ba84ec8"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .vtrip(2'b00),
		  .width(1))
		Pin_Button_Interrupt
		 (.oe(tmpOE__Pin_Button_Interrupt_net),
		  .y({1'b0}),
		  .fb({Net_62}),
		  .io({tmpIO_0__Pin_Button_Interrupt_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Button_Interrupt_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Button_Interrupt_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_Button_Interrupt_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_Button_0_net;
	wire [0:0] tmpIO_0__Pin_Button_0_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Button_0_net;
	electrical [0:0] tmpSIOVREF__Pin_Button_0_net;

	cy_psoc3_pins_v1_10
		#(.id("6d2de6e4-a4b9-433c-9b3c-d1af44b9c6eb"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .width(1))
		Pin_Button_0
		 (.oe(tmpOE__Pin_Button_0_net),
		  .y({1'b0}),
		  .fb({Net_63}),
		  .io({tmpIO_0__Pin_Button_0_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Button_0_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Button_0_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_Button_0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("b231035c-a826-406f-b77c-35b1e79be732"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("cef62a7d-c2ad-4521-81a1-9c1ba6216cc8"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("e4043904-59b1-4c91-8665-b9a0776ad7ff"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpIO_0__Pin_LED_Debug_net;
	wire [0:0] tmpINTERRUPT_0__Pin_LED_Debug_net;
	electrical [0:0] tmpSIOVREF__Pin_LED_Debug_net;

	cy_psoc3_pins_v1_10
		#(.id("11676185-e157-4daa-afd0-9f8c3583a445"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .width(1))
		Pin_LED_Debug
		 (.oe(tmpOE__Pin_LED_Debug_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_LED_Debug_net[0:0]}),
		  .io({tmpIO_0__Pin_LED_Debug_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_LED_Debug_net),
		  .interrupt({tmpINTERRUPT_0__Pin_LED_Debug_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_LED_Debug_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
