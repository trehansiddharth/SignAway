...
void  SPI_WriteTxData(uint16 txData);
    ...
    void  SPI_WriteTxDataZero(uint16 txDataByte) \
                                              ;
...
***************************************/
    ...
    #define SPI_TX_AUX_CONTROL_DP0_PTR       (  (reg8 *) \
        ...
        #define SPI_TX_AUX_CONTROL_DP1_REG   (* (reg8 *) \
                SPI_BSPIS_es2_SPISlave_sR16_DpMISO_u1__DP_AUX_CTL_REG)
        ...
        #define SPI_TXDATA_ZERO_REG          (* (reg16  *) \
                SPI_BSPIS_es3_SPISlave_sR16_Dp_u0__A0_REG)
        ...
        #define SPI_TXDATA_REG                (* (reg16  *) \
                SPI_BSPIS_es3_SPISlave_sR16_Dp_u0__F0_REG)

        #define SPI_TXDATA_PTR                (  (reg16  *) \
                SPI_BSPIS_es3_SPISlave_sR16_Dp_u0__F0_REG)

        #define SPI_RXDATA_REG                (* (reg16  *) \
                SPI_BSPIS_es3_SPISlave_sR16_Dp_u0__F1_REG)
        ...
        #define SPI_RXDATA_PTR                (  (reg16  *) \
        ...
        #else /* 16bit - SPIS */
            #define SPI_TXDATA_ZERO_REG           (* (reg16  *) \
                    SPI_BSPIS_es3_SPISlave_sR16_Dp_u0__16BIT_A0_REG)
            ...
            #define SPI_TXDATA_REG                (* (reg16  *) \
                    SPI_BSPIS_es3_SPISlave_sR16_Dp_u0__16BIT_F0_REG)

            #define SPI_TXDATA_PTR                (  (reg16  *) \
                    SPI_BSPIS_es3_SPISlave_sR16_Dp_u0__16BIT_F0_REG)

            #define SPI_RXDATA_REG                (* (reg16  *) \
                    SPI_BSPIS_es3_SPISlave_sR16_Dp_u0__16BIT_F1_REG)
    ...
    #define SPI_TX_AUX_CONTROL_DP0_REG       (* (reg8 *) \
            SPI_BSPIS_es3_SPISlave_sR16_Dp_u0__DP_AUX_CTL_REG)
    #define SPI_TX_AUX_CONTROL_DP0_PTR       (  (reg8 *) \
            SPI_BSPIS_es3_SPISlave_sR16_Dp_u0__DP_AUX_CTL_REG)
    ...
    #define SPI_RX_AUX_CONTROL_DP0_PTR       (  (reg8 *) \
        ...
        #define SPI_TX_AUX_CONTROL_DP1_REG   (* (reg8 *) \
                SPI_BSPIS_es3_SPISlave_sR16_Dp_u1__DP_AUX_CTL_REG)
        #define SPI_TX_AUX_CONTROL_DP1_PTR   (  (reg8 *) \
                SPI_BSPIS_es3_SPISlave_sR16_Dp_u1__DP_AUX_CTL_REG)
