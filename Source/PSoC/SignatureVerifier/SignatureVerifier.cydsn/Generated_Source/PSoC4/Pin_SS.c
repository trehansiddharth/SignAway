...
#define SetP4PinDriveMode(shift, mode)  \
    do { \
        Pin_SS_PC =   (Pin_SS_PC & \
                                (uint32)(~(uint32)(Pin_SS_DRIVE_MODE_IND_MASK << (Pin_SS_DRIVE_MODE_BITS * (shift))))) | \
                                (uint32)((uint32)(mode) << (Pin_SS_DRIVE_MODE_BITS * (shift))); \
    } while (0)
...
{
	SetP4PinDriveMode(Pin_SS__0__SHIFT, mode);
}
