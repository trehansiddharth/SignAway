...
#include "SPI_PVT.h"
    ...
    volatile uint16 SPI_txBuffer[SPI_TX_BUFFER_SIZE] = {0u};
    ...
    volatile uint16 SPI_rxBuffer[SPI_RX_BUFFER_SIZE] = {0u};
...
void SPI_WriteTxData(uint16 txData) 
{
    ...
    *******************************************************************************/
    ...
    {
        CY_SET_REG16(SPI_TXDATA_ZERO_PTR, txDataByte);
    }
