...
jumtab:
   ...
   .dw writvt             ; command 'v' 16
   .dw writbt             ; command 'w' 17
...
;===============================================================
; command readbt  'r'
; you give this command an address and it reads the byte at that
; address.
;===============================================================
readbt:
   lcall getbyt           ; get address high byte
   mov   dph, a            ; save in R7
   lcall prthex

   lcall getbyt           ; get address low byte
   mov  dpl, a           ; push lsb of jump address
   lcall prthex
...
;===============================================================
; command writbt  'w'
; you give this command an address and a value and it writes that
; byte value to the address you specify
;===============================================================
writbt:
	lcall getbyt
	mov dph, a
...
;===============================================================
; command writvt  'v'
; you give this command an address and it prompts you for values
; to write starting at that address until you hit 256 bytes or
; you press enter
;===============================================================
writvt:
  lcall getbyt
